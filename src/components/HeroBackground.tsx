...
export default function HeroBackground() {
  ...
  return (
    <div
      aria-hidden="true"
      className="absolute inset-0 z-0 overflow-hidden pointer-events-none opacity-40 dark:opacity-20"
    >
      ...
      >
        <svg
          className="w-full h-full text-accent-secondary"
          viewBox="0 0 1000 1000"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M-100 500 C 200 300, 400 800, 1100 500"
            stroke="currentColor"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M-100 600 C 200 400, 400 900, 1100 600"
            stroke="currentColor"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M-100 700 C 200 500, 400 1000, 1100 700"
            stroke="currentColor"
            strokeWidth="2"
            fill="none"
          />
      ...
      >
        ...
        >
          <path
            d="M0 200 Q 400 500 900 300 T 1920 400"
            stroke="currentColor"
            strokeWidth="1"
            fill="none"
          />
          <path
            d="M0 250 Q 420 550 920 350 T 1920 450"
            stroke="currentColor"
            strokeWidth="1"
            fill="none"
          />
          <path
            d="M0 300 Q 440 600 940 400 T 1920 500"
            stroke="currentColor"
            strokeWidth="1"
            fill="none"
          />
          <path
            d="M1600 0 Q 1400 500 1700 1080"
            stroke="currentColor"
            strokeWidth="1"
            fill="none"
            opacity="0.5"
          />
          <path
            d="M1550 0 Q 1350 500 1650 1080"
            stroke="currentColor"
            strokeWidth="1"
            fill="none"
            opacity="0.3"
