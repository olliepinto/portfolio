  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-sm font-medium text-text-muted lowercase font-sans">
          {data.hero.badge}
        </span>
      </motion.div>
      ...
      <motion.p
        variants={item}
        className="text-xl text-text-muted max-w-lg leading-relaxed font-sans font-light"
      >
      ...
      <motion.div
        variants={item}
        className="pt-2 flex flex-col sm:flex-row gap-4 w-full md:w-auto"
      >
        <a
          href="#work"
